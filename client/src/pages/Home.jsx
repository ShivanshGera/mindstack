        ...
        text-white justify-between'>
            ...
            <div>
                <CodeBlocks
                    ...
                    heading={
                        <div className='text-4xl front-semibold'>
                            Unlock Your
                    ...
                    subheading={
                        "Our courses are designed and taught by industry experts who have years of experience in coding and are passionate about sahring their with you."
                ...
                <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
                    ...
                    <div className='flex flex-col gap-10 w-[40%] items-start'>
                        <div className='text-[16px]'>
                            The modern MindStack is the dictates its own terms.Today, to be a competitive
